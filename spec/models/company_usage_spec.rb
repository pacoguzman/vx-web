...
describe CompanyUsage do
  describe '#calculate' do
    it 'returns current company_usage' do
      ...
      create(:job, build: today_build, status: 4, started_at: 20.minutes.ago, finished_at: 10.minutes.ago - 20.seconds)

      yesterday_build = create(:build, project: project, number: 2)
      create(:job, build: yesterday_build, status: 3, started_at: 1.day.ago.beginning_of_day + 1.hour, finished_at: 1.day.ago.beginning_of_day + 2.hour)

      month_build = create(:build, project: project, number: 1)
      create(:job, build: month_build, status: 3, started_at: 20.days.ago, finished_at: 20.days.ago + 4.hours)
